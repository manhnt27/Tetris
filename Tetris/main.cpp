...
SDL_Event event;
Game game;
int randomColor=0,gameSpeed,tmpGameSpeed,point,dx;
...
void showMessHelp();
void showMessSpeed(int& gameSpeed);
void interpretEvent(SDL_Event event,int& gameSpeed);
     ...
     if (SDL_Init(SDL_INIT_VIDEO) !=0)
        ...
        while (!done) {
            ...
            while (SDL_PollEvent(&event))
                interpretEvent(event,gameSpeed);
...
void showMessSpeed(int& gameSpeed){
    ...
    switch(buttonid)
    {
        case -1: SDL_Log("No button selected");
        break;
        case 0: {pause=false;cout<<"Slow";tmpGameSpeed=2000;cout<<gameSpeed<<"v";}
        break;
        case 1: {pause=false;cout<<"Normal";tmpGameSpeed=1000;cout<<gameSpeed<<"v";}
        break;
        case 2: {pause=false;cout<<"Fast";tmpGameSpeed=100;cout<<gameSpeed<<"v";}
        break;
    }
}
/////////////////////////////////////////////////////////////////////////////////
